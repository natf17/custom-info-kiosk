...
public class SQLStatements {
    ...
    protected static String INSERT_RICHTEXTLONGDESCR_FIELD_TABLE = "INSERT INTO rich_text_long_description_field(field_name, field_value, field_container) "
                                                                    + "VALUES (?, ?, ?)";
    
    protected static String INSERT_REGTEXTLONGDESCR_FIELD_TABLE = "INSERT INTO regular_text_long_description_field(field_name, field_value, field_container) "
                                                                    + "VALUES (?, ?, ?)";
                                                    
    protected static String INSERT_IMAGE_FIELD_TABLE = "INSERT INTO image_field(field_name, field_container) "
                                                                    + "VALUES (?, ?) RETURNING ID";

    protected static String INSERT_IMAGE_TABLE = "INSERT INTO image(location, width, height, image_field) "
                                                                    + "VALUES (?, ?, ?, ?)";

    protected static String INSERT_BUTTON_FIELD_TABLE = "INSERT INTO button_field(field_name, field_value, field_container) "
                                                                    + "VALUES (?, ?, ?)";
                    
    protected static String INSERT_URL_FIELD_TABLE = "INSERT INTO url_field(field_name, field_value, field_container) "
                                                                    + "VALUES (?, ?, ?)";
    ...
    protected static String FIND_PAGE_TITLE_FIELD_TABLE = "SELECT page_title_field.field_name AS PTF_FNAME, page_title_field.field_value AS PTF_FVALUE "
    ...
    protected static String FIND_RICHTEXTLONGDESCR_FIELD_TABLE = "SELECT rich_text_long_description_field.field_name AS RTLDF_FNAME, rich_text_long_description_field.field_value AS RTLDF_FVALUE "
                                                + "FROM rich_text_long_description_field "
                                                + "WHERE rich_text_long_description_field.field_container = ?";
                        
    protected static String FIND_REGTEXTLONGDESCR_FIELD_TABLE = "SELECT regular_text_long_description_field.field_name AS REGTLDF_FNAME, regular_text_long_description_field.field_value AS REGTLDF_FVALUE "
                                                + "FROM regular_text_long_description_field "
                                                + "WHERE regular_text_long_description_field.field_container = ?";

    protected static String FIND_IMAGE_FIELD_TABLE = "SELECT image_field.id AS IF_ID, image_field.field_name AS IF_FNAME, "
    ...
    protected static String FIND_BUTTON_FIELD_TABLE = "SELECT button_field.field_name AS BF_FNAME, button_field.field_value AS BF_FVALUE "
                                                + "FROM button_field "
